...
public class LoggingAspect {
	...
	public void beforeController(JoinPoint jp) {
		...
		Object memberLogin = req.getSession().getAttribute("memberLogin");
		Object artistLogin = req.getSession().getAttribute("artistLogin");
		...
		if(memberLogin != null) {
			...
			member = (Member) artistLogin;
			sb.append( String.format("[요청] ip : %s / 작가번호 : %d, 이메일 : %s", clientIp, member.getMemberNo(), member.getMemberEmail()) );
		} else {
